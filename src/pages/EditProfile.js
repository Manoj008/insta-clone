...
const EditProfilePicture = ({ user }) => {
    ...
    const imageSelectHandler = (e) => {
        getBase64(e.target.files[0])
            .then(result => {
                ...
                document.getElementById("dp").src = result;
            })
            .catch(err => {
                console.log(err);
            });
    ...
    return (
        <div className="flex items-center justify-center py-5 m-10 ">
            <div className='flex items-center justify-between mr-10 rounded-full w-16 h-16 '>

                <img src={user.profilePicture ? user.profilePicture : "/images/avatars/dali.jpg"}
                    alt="profile pic"
                    id="dp"
...
const EditDetails = ({ user }) => {
    ...
    return (
        <>
            <div className="grid grid-cols-4 items-center px-auto content-center mx-auto px-auto w-1/2 my-10">
                <label for="userFullname">
                    <p className="font-bold text-gray-700 ">Name</p>
                </label>
                <input type="text" id="userFullname" onChange={(e) => setFullName(e.target.value)} value={fullName}
                    className=" text-md col-span-3 rounded text-start border border-gray-500 bg-gray-200 w-full   py-5 px-4 h-1.5 " />
            </div>
            <div className="grid grid-cols-4  items-center px-auto content-center mx-auto px-auto w-1/2 my-10">
                <label for="username">
            ...
            <div className="grid grid-cols-4  items-center px-auto content-center mx-auto px-auto w-1/2 my-10">
                ...
                <textarea rows={3} id="bio" onChange={(e) => setBio(e.target.value)} value={bio}
                    className=" text-md col-span-3 rounded text-start border border-gray-500 bg-gray-200 w-full  py-3 px-4 h-3.0 " />
            </div>
            <div className="grid grid-cols-4  items-center px-auto content-center mx-auto px-auto w-1/2 my-10">
                <label for="email">
            ...
            <div className="grid grid-cols-4  items-center px-auto content-center mx-auto px-auto w-1/2 my-10">
                ...
                <input type="text" id="mobile" maxLength={10}
                    ...
                    className="phone validate text-md col-span-3 rounded text-start border border-gray-500 bg-gray-200 w-full  py-5 px-4 h-1.5 " />
            </div>
            <div className="grid grid-cols-4  items-center px-auto content-center mx-auto px-auto w-1/2 my-10">
                <label for="gender">
                ...
                <select id="gender" value={gender} onChange={(e) => setGender(e.target.value)}
                    placeholder="Select.."
                    className=" text-md col-span-3 rounded text-start border border-gray-500 bg-gray-200 w-full  py-2 px-4  " >
